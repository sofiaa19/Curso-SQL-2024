...
create schema PreEntrega_prueba;
use PreEntrega_prueba;

-- Creaación de las tablas 
...
-- A la tabla de Calificaciones no le puedo agregar las FK, dice que no existen las columnas de PK referenciadas
